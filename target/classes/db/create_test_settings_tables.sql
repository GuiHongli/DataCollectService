...
CREATE TABLE IF NOT EXISTS `test_settings_device_imsi_mapping` (
  ...
  UNIQUE KEY `uk_gpsi` (`gpsi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='deviceid和GPSI对应关系表';
